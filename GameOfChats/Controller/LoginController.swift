...
class LoginController: UIViewController {
    ...
    func handleLogin(){
        guard let email = emailTextField.text, let password = passwordTextField.text else {
            print("error email, password enterred")
            return
        }
    ...
    lazy var loginRegisterSegmentedControl: UISegmentedControl = {
        ...
        sc.addTarget(self, action: #selector(handlelLoginRegisterChange), for: .valueChanged)
        return sc
    }()
    
    @objc func handlelLoginRegisterChange() {
        ...
        // change height of inputs container view but how ??
    ...
    func setupInputsContainerView(){
        ...
        inputsContainerView.widthAnchor.constraint(equalTo: view.widthAnchor, constant: -12).isActive = true
